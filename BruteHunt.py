...
def banner():
    print(Color.yellow_bold+"""                    """+Color.no_colored+"""     
"""+Color.blue_bold+"""-----------------------------------------------------------------------"""+Color.no_colored+"""    
"""+Color.red_bold+""" ______   ______ _     _ _______ _______ _     _ _     _ __   _ _______"""+Color.no_colored+"""
"""+Color.red_bold+""" |_____] |_____/ |     |    |    |______ |_____| |     | | \  |    |   """+Color.no_colored+"""
"""+Color.red_bold+""" |_____] |    \_ |_____|    |    |______ |     | |_____| |  \_|    |   """+Color.no_colored+"""

"""+Color.blue_bold+"""------------------------ Coded By Faizan Mark -------------------------"""+Color.no_colored+"""

"""+Color.yellow_bold+"""[i]"""+Color.no_colored+""" BruteHunt - Brute Force attacks SSH, FTP, Telnet, PostgreSQL, RDP, VNC with Hydra, Medusa and Ncrack
...
def about():
    ...
    print("    Github: "+Color.yellow_bold+"https://github.com/Faizanmark",Color.no_colored)
    print("    Instagram: "+Color.yellow_bold+"@faizan_mark",Color.no_colored)
